...
|--------|----------|----------|----------|------|----------|
| T001 | 单位转换器 | 正常单位转换 | 已选择“长度”属性 | 1. 点击单位转换器按钮<br>2. 进入单位转换器页面<br>3. 选择源项与目标项<br>4. 输入数值<br>5. 点击转换按钮<br>6. 校验转换结果 | 1. 显示“米 → 英尺”页面<br>2. 输入框显示“5”<br>3. 结果显示“16.404 英尺” |
| T002 | 单位转换器 | 边界值转换 | 已选择“温度”属性 | 1. 点击单位转换器按钮<br>2. 进入单位转换器页面<br>3. 选择源项与目标项<br>4. 输入数值<br>5. 点击转换按钮<br>6. 校验转换结果 | 1. 显示“摄氏度 → 华氏度”页面<br>2. 输入框显示“-273.15”<br>3. 结果显示“-459.67 华氏度” |
| T003 | 单位转换器 | 无效输入检测 | 已选择“长度”属性 | 1. 点击单位转换器按钮<br>2. 进入单位转换器页面<br>3. 选择源项与目标项<br>4. 输入数值<br>5. 点击转换按钮<br>6. 校验转换结果 | 1. 显示错误提示“请输入有效数字”<br>2. 输入框内容保持为空 |
...
| 场景ID | 所属功能 | 场景名称 | 前置条件 | 步骤 | 预期结果 |
|--------|----------|----------|----------|------|----------|
| T004 | 属性选择与排序 | 选择多个属性 | 无 | 1. 点击属性选择与排序按钮<br>2. 进入属性选择与排序页面<br>3. 输入或选择必要参数<br>4. 执行关键操作<br>5. 查看反馈结果<br>6. 校验结果是否符合预期 | 1. 返回首页<br>2. 看到“长度”、“重量”、“温度”三个卡片 |
| T005 | 属性选择与排序 | 拖拽排序 | 无 | 1. 点击属性选择与排序按钮<br>2. 进入属性选择与排序页面<br>3. 输入或选择必要参数<br>4. 执行关键操作<br>5. 查看反馈结果<br>6. 校验结果是否符合预期 | 1. 返回首页<br>2. “温度”卡片显示在最上方 |
...
| 场景ID | 所属功能 | 场景名称 | 前置条件 | 步骤 | 预期结果 |
|--------|----------|----------|----------|------|----------|
| T006 | 单位选择与隐藏 | 隐藏单位 | 无 | 1. 点击单位选择与隐藏按钮<br>2. 进入单位选择与隐藏页面<br>3. 选择源项与目标项<br>4. 输入数值<br>5. 点击转换按钮<br>6. 校验转换结果 | 1. 返回首页<br>2. “英寸”不在任何转换页面中显示 |
| T007 | 单位选择与隐藏 | 恢复隐藏单位 | 无 | 1. 点击单位选择与隐藏按钮<br>2. 进入单位选择与隐藏页面<br>3. 选择源项与目标项<br>4. 输入数值<br>5. 点击转换按钮<br>6. 校验转换结果 | 1. 返回首页<br>2. “英寸”出现在转换页面中 |
...
| 场景ID | 所属功能 | 场景名称 | 前置条件 | 步骤 | 预期结果 |
|--------|----------|----------|----------|------|----------|
| T008 | 多语言支持 | 切换语言 | 无 | 1. 点击多语言支持按钮<br>2. 进入设置页面<br>3. 选择目标设置项<br>4. 修改参数<br>5. 保存设置<br>6. 返回并校验设置生效 | 1. 返回首页<br>2. 所有界面文字变为英文 |
| T009 | 多语言支持 | 语言切换后刷新 | 无 | 1. 点击多语言支持按钮<br>2. 进入设置页面<br>3. 选择目标设置项<br>4. 修改参数<br>5. 保存设置<br>6. 返回并校验设置生效 | 1. 返回首页<br>2. 界面文字变为中文 |
...
| 场景ID | 所属功能 | 场景名称 | 前置条件 | 步骤 | 预期结果 |
|--------|----------|----------|----------|------|----------|
| T010 | 货币汇率换算 | 正常货币转换 | 无 | 1. 点击货币汇率换算按钮<br>2. 进入货币汇率换算页面<br>3. 选择源项与目标项<br>4. 输入数值<br>5. 点击转换按钮<br>6. 校验转换结果 | 1. 显示“人民币 → 美元”页面<br>2. 输入框显示“100”<br>3. 结果显示“14.3 美元” |
| T011 | 货币汇率换算 | 网络断开时的处理 | 无 | 1. 点击货币汇率换算按钮<br>2. 进入货币汇率换算页面<br>3. 选择源项与目标项<br>4. 输入数值<br>5. 点击转换按钮<br>6. 校验转换结果 | 1. 显示“网络不可用”提示<br>2. 无法获得实时汇率 |
...
| 场景ID | 所属功能 | 场景名称 | 前置条件 | 步骤 | 预期结果 |
|--------|----------|----------|----------|------|----------|
| T012 | 计算器工具 | 基本运算 | 无 | 1. 点击计算器工具按钮<br>2. 进入计算器页面<br>3. 输入表达式<br>4. 点击等于按钮<br>5. 查看计算结果<br>6. 校验结果正确性 | 1. 显示“10” |
| T013 | 计算器工具 | 科学计算 | 无 | 1. 点击计算器工具按钮<br>2. 进入计算器页面<br>3. 输入表达式<br>4. 点击等于按钮<br>5. 查看计算结果<br>6. 校验结果正确性 | 1. 显示“0.5” |
...
| 场景ID | 所属功能 | 场景名称 | 前置条件 | 步骤 | 预期结果 |
|--------|----------|----------|----------|------|----------|
| T014 | 搜索功能 | 按单位搜索 | 无 | 1. 点击搜索功能按钮<br>2. 进入搜索功能页面<br>3. 输入搜索关键词<br>4. 触发搜索<br>5. 查看结果列表<br>6. 校验结果准确性 | 1. 显示“米”相关单位和属性 |
| T015 | 搜索功能 | 按属性搜索 | 无 | 1. 点击搜索功能按钮<br>2. 进入搜索功能页面<br>3. 输入搜索关键词<br>4. 触发搜索<br>5. 查看结果列表<br>6. 校验结果准确性 | 1. 显示“温度”相关单位和页面 |
...
| 场景ID | 所属功能 | 场景名称 | 前置条件 | 步骤 | 预期结果 |
|--------|----------|----------|----------|------|----------|
| T016 | 系统设置 | 更改主题 | 无 | 1. 点击系统设置按钮<br>2. 进入设置页面<br>3. 选择目标设置项<br>4. 修改参数<br>5. 保存设置<br>6. 返回并校验设置生效 | 1. 返回首页<br>2. 应用界面变为深色主题 |
| T017 | 系统设置 | 更改语言 | 无 | 1. 点击系统设置按钮<br>2. 进入设置页面<br>3. 选择目标设置项<br>4. 修改参数<br>5. 保存设置<br>6. 返回并校验设置生效 | 1. 返回首页<br>2. 界面文字变为法语 |
